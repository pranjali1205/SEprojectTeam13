...
=======
                                                <input required name="email" placeholder="" value={email} type="email" className="form-control sgnUp" onChange={e => onChange(e)} />
>>>>>>> 12f7400 (commit())
                                            </div>
...
=======
                                                <input required id="password" name="password" value={password} placeholder="" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
>>>>>>> 12f7400 (commit())
                                            </div>
