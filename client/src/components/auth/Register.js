...
=======
                                                <input type="text" placeholder="your name" name="name" value={name} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="email">Email-ID:</label>
                                                <input required name="email" placeholder="your email" value={email} type="email" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="mob-number">Mobile-No.:</label>
...
=======
                                                <input required id="password" name="password" value={password} placeholder="ex: 123@abc" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="password">Re-Password :</label>
                                                <input required id="password2" name="password2" value={password2} placeholder="ex: 123@abc" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
>>>>>>> 12f7400 (commit())
                                            </div>
                                            <div className="form-group2">
